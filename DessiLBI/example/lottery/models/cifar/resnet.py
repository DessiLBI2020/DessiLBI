...
if __name__=="__main__":
    ...
    if True:
        ...
        for name, p in model.named_parameters():
            ...
            # print(name)
            # print(p.size())
        optimizer = SLBI(model.parameters(),lr=0.00001,conv_lambda=1000)
...
for name in masks.keys():
    print(name)
    print(masks[name].sum([1,2,3]))
# for key in mask.keys():
#     if len(mask[key].shape)==4:
#         print(key)
#         ts_reshape = torch.reshape(mask[key], (mask[key].shape[0],-1))
#         ts_norm = torch.norm(ts_reshape,2,1)
#         print(torch.sum(ts_norm==0))
